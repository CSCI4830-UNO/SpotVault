...
export default function SpotsPage() {
  ...
  useEffect(() => {
    ...
    setSpots(allSpots);
    // Do not select a spot on initial load
  }, []);
  ...
  return (
    <div className="flex flex-col h-screen bg-black text-white">
      {/* Header */}
      <div className="border-b border-gray-700 px-8 py-6 flex-shrink-0">
      ...
      <div className="flex-1 overflow-hidden px-8 py-6">
        {spots.length === 0 ? (
          ...
          <div className="flex flex-col gap-4 h-full">
            ...
            <div className="flex gap-6 flex-1 min-h-0">
              ...
              {showMap && (
                <div className="flex-[3] min-w-0">
                  <div className="border-4 border-teal-500 rounded-lg overflow-hidden h-full">
                    <SpotsMap spots={spots} selectedSpot={selectedSpot} />
                  </div>
                </div>
              )}
            ...
            {/* Bottom Info Panel */}
            {selectedSpot && (
              <div className="bg-gray-900 border border-gray-700 rounded-lg p-6 flex-shrink-0">
      ...
      {/* Footer */}
      <div className="border-t border-gray-700 px-8 py-4 flex-shrink-0">
        <Link
          href="/"
